...
/**
 * LUT 渲染模式
 * - ps：sRGB 直查（默认）——与 Photoshop「颜色查找」一致，适合 sRGB 生态配方
 * - professional：Rec.709 还原——把 sRGB 图重编码为 Rec.709 显示信号(BT.1886 γ≈2.4)后查表，用于真 Rec.709 输入配方
 */
